...
import type { SecretsStore, Stored } from "./index.js";

export function memoryStore(entries: Record<string, Stored> = {}, stamp: { when?: () => string; from?: string } = {}): SecretsStore & { entries: Record<string, Stored> } {
  return {
